...
2. Get the Fortress Realm Proxy jar.
 ...
 Place the fortress-realm proxy jar, generated by the **FORTRESS_REALM_HOME** package into **TOMCAT_HOME**/lib folder.  The proxy jar name is named fortress-realm-proxy-[version].jar and located here: FORTRESS_REALM_HOME/proxy/target.
